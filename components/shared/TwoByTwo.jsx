export default function TwoByTwo({shortStyle}) {
    return(
        <div className={shortStyle.twoByTwo}>
            <div className={shortStyle.profile}>
                <h3 className={shortStyle.profileHeaders}>Mary Mac Murray</h3>
            ...
            <div className={shortStyle.profile}>
                <h3 className={shortStyle.profileHeaders}>Miykaelah (Rajmani) Sinclair</h3>
            ...
            <div className={shortStyle.profile}>
                <h3 className={shortStyle.profileHeaders}>Brandon Gottshall</h3>
            ...
            <div className={shortStyle.profile}>
                <h3 className={shortStyle.profileHeaders}>Heather Sterman</h3>
